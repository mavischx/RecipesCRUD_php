...
function addRecipe() {
	...
	$query = "INSERT INTO recipes
                 (name, url, author, time, servings, ingredients, instructions, picture,category)VALUES('$name', '$url', '$author', '$time', '$servings', '$ingredients', '$instructions', '$picture', '$category')";
	try {global $db;
		$db->exec($query);
...
function updateRecipe($id) {
	...
	$picture = $recipe->picture;
    $category = $recipe->category;
	$query = "UPDATE recipes SET name='$name', url='$url', author='$author', time='$time', servings='$servings', ingredients='$ingredients', instructions='$instructions', picture='$picture', category='$category' WHERE id='$id'";
	try {
		global $db;
		 $db->exec($query); 
		 echo json_encode($recipe);
